...
const teetimeCtrl = require('./teetime.controller');

const router = express.Router(); // eslint-disable-line new-cap

router.route('/')
 /**
 * @api {get} /api/v1/teetimes Retrieve all teetimes
 * @apiName GetAll
 * @apiGroup course
 * @apiVersion 0.1.0
 * @apiParam {Number} id teetimes unique ID.
 *
 ...
 * @apiSuccess {String} thumbnail  Url for the teetimes thumbnail.
 * @apiSuccess {String} banner  Url for the teetimes banner.
 *
 ...
 *
 */
  .get(teetimeCtrl.list)

 /**
 * @api {post} /api/v1/teetimes Create a course
 * @apiVersion 0.1.0
 * @apiName Create
 * @apiGroup course
 ...
 *
 */
  .post(teetimeCtrl.create);

router.route('/:courseId')
 /**
 * @api {get} /api/v1/teetimes/:id Retrieve one course
 * @apiName Get
 * @apiGroup course
 * @apiVersion 0.1.0
 * @apiParam {Number} id teetimes unique ID.
 ...
 */
 ...
 /**
 * @api {put} /api/v1/teetimes/:id Update a course
 * @apiName Put
 * @apiGroup course
 * @apiVersion 0.1.0
 * @apiPermission authenticated course
 ...
 *     }
 */
  .put(teetimeCtrl.update)

 /**
 * @api {delete} /api/v1/teetimes/:id Delete a course
 * @apiName Delete
 * @apiGroup course
 * @apiVersion 0.1.0
 * @apiPermission authenticated course
 ...
 *     }
 */
  .delete(teetimeCtrl.remove);

/** Load course when API with courseId route parameter is hit */
router.param('teetimeId', teetimeCtrl.load);
